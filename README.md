...
| **Models**                                     | **Vessel visibility** <br> 3: Clearly visible \ 2: Visible \ 1: Not visible                                                   | **Airway visibility**  \ 3: Lobar and intermediate bronchi \ 2: Main bronchus and rump \ 1: Trachea                                                               | **Bone shadow suppression** \ 3: Nearly perfect \ 2: Less than 5 unsuppressed bones \ 1: 5 or more unsuppressed bones      | **Overall bone shadow suppression performance** \ 1: Excellent \ 3: Average \ 5: Poor           | **Nodule visibility** \ 3: More apparent \ 2: Equally as apparent \ 1: Less apparent |
| ---------------------------------------------- | :----------------------------------------------------------------------: | :-----------------------------------------------------------------------------------: | :-------------------------------: | :--------------------------------------------------------: | :-------------------: |
